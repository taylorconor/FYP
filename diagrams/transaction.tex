...
\small{\textit{$T_{An}$ = $KL_{AT}[n](ts_A|loc_A|ID_{An}|KP_{Bm})$}}\\
\small{\textit{publish $ID_{An}|KL_{AL}[n](ID_{An-1}|ts_A)|T_{An}$}}
\end{tabular}};

\draw (B_10) node[below,text centered]{\begin{tabular}{r}
\small{\textit{$T_{Bm}$ = $KL_{BT}[m](ts_B|loc_B|ID_{Bm}|KP_{An})$}}\\
\small{\textit{publish $ID_{Bm}|KL_{BL}[m](ID_{Bm-1}|ts_B)|T_{Bm}$}}
\end{tabular}};
\end{tikzpicture}