...
\node[fill=white,label=right:Requesting node's transactions] (L1) at (-2,-1) {};
\node[fill=gray,label=right:Requesting node's alibis transactions] (L2) at (-2,-1.5) {};
\node[fill=black,label=right:Alibi node's alibis transactions] (L3) at (-2,-2) {};
